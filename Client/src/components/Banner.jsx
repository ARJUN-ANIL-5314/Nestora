...
function Banner() {
  return (
    <div
      className="relative h-[450px] md:h-[550px] w-full bg-[url('../images/freepik__upload__50264.png')] bg-cover bg-center bg-no-repeat bg-light-p bg-opacity-20 backdrop-blur-sm flex items-center"
    >
