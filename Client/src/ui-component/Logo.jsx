...
import logoDark from 'assets/images/Home/Nestora-1-.png';
...
const Logo = () => {
  ...
  return (
     ...
     */
    <>
    <img src={logoDark} alt="Logo" className='w-full p-auto h-20 mb-0 p-0' />
    {/* <p className='text-dark-b text-center' >Nestora</p> */}
    </>
  );
};
