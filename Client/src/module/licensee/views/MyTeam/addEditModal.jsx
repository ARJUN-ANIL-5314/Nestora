            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  <MenuItem value="licnseAcnt">Accountant</MenuItem>
                  <MenuItem value="licnseMngr">Manager</MenuItem>
                  <MenuItem value="licnseOptr ">Operator</MenuItem>
                </Select>
                <ErrorMessage name="role" component="div" style={{ color: '#f54d4f', fontSize: 12, marginTop: '12px' }} />
              </Grid>
              {formtype === 'addform' && (
                <Grid item xs={12} sm={6}>
                  <FormLabel>
