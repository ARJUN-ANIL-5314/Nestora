...
// import { Modal, Box, Typography, TextField, Button, IconButton, Radio, Grid, useMediaQuery } from '@mui/material';
...
// function CustomerModal({ open, handleClose, onSelect }) {
...
//              <Typography id="modal-modal-title" style={{ fontSize: isMobile ? '10px' : '16px' ,textAlign:'start'}}>
//                 Select Customer
//               </Typography>
//             ):(<></>)}
//               <TextField
