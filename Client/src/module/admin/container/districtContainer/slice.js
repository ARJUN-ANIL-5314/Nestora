...
const districtSlice = createSlice({
  ...
  reducers: {
    ...
    getDistrictByFilter: (state) => {
      state.loading = true;
      state.error = null;
    },
    districtByFilterSuccess: (state, action) => {
      state.loading = false;
      state.districtByFilter = action.payload;
    },
    districtByFilterFail: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    }
  }
...
export const {
  getDistrictByFilter,
  districtByFilterSuccess,
  districtByFilterFail,
  getDistrict,
  getDistrictSuccess,
  getDistrictFail,
  addDistrict,
